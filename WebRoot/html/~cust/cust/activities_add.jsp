...
<table class="query_form_table">
	<tr>
		...
		<input type=hidden name="activity.cstCustomer.custId" value="${custId }"/>
	...
	<tr>
		...
		<th>客户活动名称</th>
		<td><input name="activity.atvCustName" /></td>
	</tr>	
	<tr>
		<th>详细信息</th>
		<td colspan="3">
			<textarea name="activity.atvDesc"cols="50" rows="6"> </textarea>
		</td>
	</tr>
</table>
</form>
